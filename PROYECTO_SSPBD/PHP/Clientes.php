...
$sql = "SELECT ID_CLIENTE, NOMBRE, DIRECCION, TELEFONO FROM clientes"; // Corregir el nombre de la tabla
...
<body>
    ...
    <table>
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            $sql_insert = "INSERT INTO clientes (NOMBRE, DIRECCION, TELEFONO) VALUES ('$nombre', '$direccion', '$telefono')";
        ...
        <tr id="filaAgregar">
            <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                <td><input class="G" type="submit" value="Guadar"></td>
                <td><input class="T" type="text" name="Nombre" id=""></td>
                <td><input class="T" type="text" name="Direccion" id=""></td>
